...
export default async function BlogPost({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const isExactLayout = ['taxes', 'retirement', 'credit-cards', 'investing', 'real-estate', 'insurance', 'government-benefits', 'budgeting-saving', 'earning-more'].includes(post.categorySlug);
